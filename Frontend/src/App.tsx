        ...
        >
            <div className="max-w-6xl mx-auto px-4 sm:px-6 h-[60px] flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center gap-7">
                    {NAV_LINKS.map((link) => (
                        <motion.button
                            key={link}
                            onClick={() => go(link)}
                            className="relative text-[13px] pb-[2px] cursor-pointer"
                            initial={false}
                            animate={{
                            ...
                            whileHover={{
                                ...
                                textShadow: dark ? '0px 2px 8px rgba(255,255,255,0.4)' : '0px 2px 8px rgba(0,0,0,0.2)',
                                y: -1,
                            }}
                ...
                <div className="hidden md:flex items-center gap-4">
                    <motion.a
                        href="https://github.com/rohan-ak43" target="_blank" rel="noreferrer"
                        ...
                        whileHover={{
                            scale: 1.08,
                            color: dark ? '#FFFFFF' : '#000000',
                            filter: dark ? 'drop-shadow(0px 0px 8px rgba(255,255,255,0.4))' : 'drop-shadow(0px 0px 8px rgba(0,0,0,0.2))'
                        }}
                        transition={{ duration: 0.2, ease: "easeOut" }}
                    >
                    ...
                    <motion.a
                        href="https://www.linkedin.com/in/arohancist/" target="_blank" rel="noreferrer"
                        className="cursor-pointer flex items-center justify-center"
                        style={{ color: iconColor }}
                        aria-label="LinkedIn"
                        whileHover={{
                    ...
                    >
                        {NAV_LINKS.map((link) => (
                            <motion.button
                                key={link}
                                onClick={() => go(link)}
                                className="block w-full text-left py-3 text-sm cursor-pointer"
                                initial={false}
                                animate={{
                                    color: active === link ? textColor : subTextColor,
                                    fontWeight: active === link ? 600 : 500,
